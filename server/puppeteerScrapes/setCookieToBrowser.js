...
module.exports = function (cookies){
    ...
    return new Promise(async (resolve, reject)=>{
        ...
        try {
            ...
            await page2.goto('https://pgglobalenterprise.service-now.com/task_list.do?sysparm_nostack=true&sysparm_query=active%3Dtrue%5Eassigned_to%3Djavascript:getMyAssignments()%5EORsys_created_by%3Dphala.jl%5Esys_class_name%3Dincident%5EORsys_class_name%3Dsc_req_item&sysparm_first_row=1&sysparm_view=&sysparm_clear_stack=true', {timeout: 0});
            ...
            logger.error(error, 'An issue occured while populating Cookies to browser');
            reject();
